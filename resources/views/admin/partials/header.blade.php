    ...
    <ul class="app-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                ...
                {{-- <li>
                    <a class="dropdown-item" href="page-user.html"><i class="fa fa-user fa-lg"></i> Profil</a>
                </li> --}}
                <li>
                    <a class="dropdown-item" href="{{ route('admin.logout') }}"><i class="fa fa-sign-out fa-lg"></i> Se déconnecter</a>
                </li>
            </ul>
        </li>
    </ul>
