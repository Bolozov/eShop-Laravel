...
<section class="py-5">
    <div class="container">
                        ...
                        <div class="owl-carousel product-slider owl-loaded owl-drag" data-slider-id="1">
                            <div class="owl-stage-outer">
                                <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1680px;">
                                    <div class="owl-item active" style="width: 420px;"><a class="d-block" href="img/product-detail-1.jpg" data-lightbox="product" title="Product item 1"><img class="img-fluid" src="img/product-detail-1.jpg" alt="..."></a></div>
                                    <div class="owl-item" style="width: 420px;"><a class="d-block" href="img/product-detail-2.jpg" data-lightbox="product" title="Product item 2"><img class="img-fluid" src="img/product-detail-2.jpg" alt="..."></a></div>
                                    <div class="owl-item" style="width: 420px;"><a class="d-block" href="img/product-detail-3.jpg" data-lightbox="product" title="Product item 3"><img class="img-fluid" src="img/product-detail-3.jpg" alt="..."></a></div>
                                    <div class="owl-item" style="width: 420px;"><a class="d-block" href="img/product-detail-4.jpg" data-lightbox="product" title="Product item 4"><img class="img-fluid" src="img/product-detail-4.jpg" alt="..."></a></div>
                                </div>
                            </div>
        ...
        <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" id="magasin-tab" data-toggle="tab" href="#magasin" role="tab" aria-controls="magasin" aria-selected="false">magasin</a></li>
        </ul>
                        ...
                        <div class="col-lg-8">
                            <div class="media mb-3"><img class="rounded-circle" src="img/customer-1.png" alt="" width="50">
                                <div class="media-body ml-3">
                                    ...
                                    <p class="mb-2 text-success"><a href="{{ $product->brand->mapsLink }} " tagert="_blank"> <i class="fas fa-map-marker"></i> Google Maps</a></p>
                                </div>
                            </div>
