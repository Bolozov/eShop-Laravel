...
@section('content')
<div class="container">
    <section class="hero pb-3 bg-cover bg-center d-flex align-items-center" style="background: url({{ asset('frontend/images/hero.png') }})">
        <div class="container py-5">
            <div class="row px-4 px-lg-5">
                <div class="col-lg-6">
                    <p class="text-muted small text-uppercase mb-2">Comparateur de Prix</p>
                    <h1 class="h2 text-uppercase mb-3">Cherchez votre produit et trouvez le moins cher !</h1><a class="btn btn-dark" href="{{ route('products') }}">Liste des produits</a>
                </div>
            </div>
        </div>
    </section>
